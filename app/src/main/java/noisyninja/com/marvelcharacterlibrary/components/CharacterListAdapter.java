...
/**
 * Adapter to list all characters(MainActivity)
...
public class CharacterListAdapter extends RecyclerView.Adapter<CharacterListAdapter.ViewHolder> {
    ...
    public CharacterListAdapter(CharacterDataWrapper characterDataWrapper, View.OnClickListener onClickListener) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent,
        ...
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.list_characters, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        NoisyUtils.makeAnimation(holder.mImageView, Techniques.SlideInLeft);
    }
